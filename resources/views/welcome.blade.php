        ...
        {{-- <div class="flex-center position-ref full-height"> --}}
            ...
            <div  class="navbar" position="static">
                <div  class="justifyCenter container "  >
                        ...
                        <div class="" >
                            <a href="/login">
                                <button class="whiteColor">Login</button>
                            </a>
              ...
              <div class="container-jumbo">
                ...
                <div  class="justifyCenter container">
                    <div class=" grid-item grid-sm " >
                        ...
                        <h2 variant="subtitle1" class="whiteText">Let the best talent be hired</h2>
              ...
              <div  class=" container wrapper roleBg" >
                <div class=" grid-item grid-sm-3 " >
            
                </div>
                <div class=" grid-item grid-sm-4 ">
            ...
            <div class="footer">
                ...
                <div class="grid-container" >
                    <div class=" grid-item grid-sm-2 "></div>
                    <div class=" grid-item grid-sm-2 ">
